            ...
            if (isSupply) {
                checklist.innerHTML = `
                    ...
                    <ol class="user-home-check-list">
                        ...
                        <li>Call or text <a href="tel:+15302190940">+1 530 219 0940</a> (<a href="sms:+15302190940">SMS</a>), or email <a href="mailto:therobotservicesexchange@proton.me">therobotservicesexchange@proton.me</a>, for a seat</li>
    ...
    try {
        ...
        if (response.ok) {
            ...
            if (/seat/i.test(errMsg)) {
                errMsg += ' Call or text +1 530 219 0940, or email therobotservicesexchange@proton.me — Mickey assigns seats.';
            }
